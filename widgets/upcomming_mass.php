 ...
 */
class ProMissa_UpcomingMassTimes_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'promissa_widget_masses promissa_upcoming_masses', 'description' => __( 'This widget will show the upcoming mass times. This is recommended if your primary target audience are seekers to faith.', 'promissa' ));
        parent::__construct(
        	'promissa_widget_upcoming_masses', // Base ID
	...
	public static function createShortcode($instance)
	{
		...
		if(isset($instance['church_ID']) && !empty($instance['church_ID'])) :
			return '[promissa-upcoming-masses church_id="' . $instance['church_ID'] . '"' . $subtitle . $limit . $page . $show_title . $show_attendees . ']';
		else :
			return '[promissa-upcoming-masses' . $subtitle. $limit . $page . $show_title . $show_attendees . ']';
		endif;
		return '';
	}
	...
	public function widget( $args, $instance ) {
		...
		echo do_shortcode(ProMissa_UpcomingMassTimes_Widget::createShortcode($instance) );
	...
	public function form( $instance ) {
		...
		<code>
			<?php
				echo ProMissa_UpcomingMassTimes_Widget::createShortcode($instance);
			?>
		</code>
		<?php
	}
...
} // class ProMissa_UpcomingMassTimes_Widget
